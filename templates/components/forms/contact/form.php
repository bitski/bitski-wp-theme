...
if ( ! $is_submitted || $is_valid === false) { ?>
    ...
    echo esc_url(get_permalink()); ?>">
        ...
        <div class="mb-3">
            <label for="contact-name" class="visually-hidden"><?php
                echo esc_html__(
                        'Name',
                        'bitski-wp-theme'
                ); ?></label>
            <input id="contact-name" class="contact-name-input form-control" name="contact_name" type="text"
                   placeholder="<?php
                   echo esc_attr__('Dein Name', 'bitski-wp-theme'); ?>" required>
            <div class="invalid-feedback"><?php
                echo esc_html__('Bitte gib deinen Namen ein', 'bitski-wp-theme'); ?>
                .
            </div>
        </div>
        <div class="mb-3">
            <label for="contact-email" class="visually-hidden"><?php
                echo esc_html__(
                        'Email',
                        'bitski-wp-theme'
                ); ?></label>
            <input id="contact-email" class="contact-email-input form-control" name="contact_email" type="email"
                   placeholder="<?php
                   echo esc_attr__('Deine Email-Adresse', 'bitski-wp-theme'); ?>" required>
            <div class="invalid-feedback"><?php
                echo esc_html__(
        ...
        <div class="mb-3">
            <label for="contact-phone" class="visually-hidden"><?php
                echo esc_html__(
                        'Telefon',
                        'bitski-wp-theme'
                ); ?></label>
            <input id="contact-phone" class="contact-phone-input form-control" name="contact_phone" type="tel"
                   placeholder="<?php
                   echo esc_attr__('Deine Telefonnummer', 'bitski-wp-theme'); ?>"
                   style="position:absolute; left:-9999px;" aria-hidden="true"
                   autocomplete="off" tabindex="-1"/>
        </div>
        <div class="mb-3">
            <label for="contact-message" class="visually-hidden"><?php
                echo esc_html__(
                        'Nachricht',
                        'bitski-wp-theme'
                ); ?></label>
            <textarea id="contact-message" class="contact-message-textarea form-control" name="contact_message" rows="3"
                      placeholder="<?php
                      echo esc_attr__('Deine Nachricht', 'bitski-wp-theme'); ?>"
                      required></textarea>
            <div class="invalid-feedback"><?php
                echo esc_html__(
        ...
        <p class="form-text text-muted">
            ...
            <?php
            echo esc_html__('Mehr Informationen dazu gibt es in der', 'bitski-wp-theme'); ?>
            <a href="/datenschutz" target="_blank"
               rel="noopener noreferrer"><?php
                echo esc_html__('Datenschutzerklärung', 'bitski-wp-theme'); ?><span
            ...
            <?php
            echo esc_html__('Ein Widerruf ist jederzeit möglich', 'bitski-wp-theme'); ?>.</p>
