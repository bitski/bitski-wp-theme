...
<section class="content-body search no-results">
    ...
    <div class="content">
        <p class="alert alert-info mb-4"><?php
            if (is_search()) {
                echo esc_html__(
                        'Bitte versuchen Sie es mit anderen Suchbegriffen erneut oder nutzen Sie die Seitennavigation:',
                        'bitski-wp-theme'
                );
            } elseif (is_404()) {
                echo esc_html__(
                        'Bitte versuchen Sie es mit der Suche oder nutzen Sie die Seitennavigation:',
                        'bitski-wp-theme'
                );
            } ?>
        </p>
        ...
        echo esc_url(home_url('/')); ?>" class="btn btn-secondary">
            <?php
            echo esc_html__('Home', 'bitski-wp-theme'); ?>
        </a>
    </div>
</section>
