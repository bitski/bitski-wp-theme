...
<section class="content-body search no-results">
    <header class="alert alert-primary mb-4">
        <h2><?php
            if ( is_search() ) {
                echo esc_html( 'Es wurden leider keine Treffer gefunden.', 'bitski-wp-theme' );
            } elseif ( is_404() ) {
                echo esc_html( 'Diese Seite wurde leider nicht gefunden.', 'bitski-wp-theme' );
            } ?></h2>
    </header>
    <div class="content">
        <p class="alert alert-info mb-4"><?php
            if ( is_search() ) {
                echo esc_html( 'Bitte versuchen Sie es mit anderen Suchbegriffen erneut oder nutzen Sie die Seitennavigation:',
                        'bitski-wp-theme' );
            } elseif ( is_404() ) {
                echo esc_html( 'Bitte versuchen Sie es mit der Suche oder nutzen Sie die Seitennavigation:',
                        'bitski-wp-theme' );
            } ?>
        </p>
